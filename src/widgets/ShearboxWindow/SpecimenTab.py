...
class SpecimenTabs(QTabWidget):
    ...
    def apply_configuration(self, configuration):
        ...
        for i in range(1,5):
            specimen = f"Specimen {i}"
            self.specimens[specimen]["dimensions"].initial_weight.setText(num_to_str(configuration["shearbox"]["Specimens"][specimen]["Initial Weight"]))
            self.specimens[specimen]["dimensions"].initial_height.setText(num_to_str(configuration["shearbox"]["Specimens"][specimen]["Initial Height"]))
            ...
            self.specimens[specimen]["dimensions"].initial_width.setText(num_to_str(configuration["shearbox"]["Specimens"][specimen]["Initial Width"]))
            ...
            self.specimens[specimen]["moisture"].tin_initial_weight.setText(num_to_str(configuration["shearbox"]["Specimens"][specimen]["Tin (initial) Weight"]))
            self.specimens[specimen]["moisture"].initial_moisture.setText(num_to_str(configuration["shearbox"]["Specimens"][specimen]["Initial Moisture"]))
            self.specimens[specimen]["moisture"].initial_dry_density.setText(num_to_str(configuration["shearbox"]["Specimens"][specimen]["Initial Dry Density"]))
            self.specimens[specimen]["moisture"].initial_voids_ratio.setText(num_to_str(configuration["shearbox"]["Specimens"][specimen]["Initial Voids Ratio"]))
            self.specimens[specimen]["moisture"].initial_deg_of_sat.setText(num_to_str(configuration["shearbox"]["Specimens"][specimen]["Initial Degree of Saturation"]))

            self.specimens[specimen]["additional"].platen_weight.setText(num_to_str(configuration["shearbox"]["Specimens"][specimen]["Platen Weight"]))
            self.specimens[specimen]["additional"].platen_corr.setText(num_to_str(configuration["shearbox"]["Specimens"][specimen]["Platen Correction"]))
            self.specimens[specimen]["additional"].est_strain_at_fail.setText(num_to_str(configuration["shearbox"]["Specimens"][specimen]["Estimated Strain at Shear Failure"]))
