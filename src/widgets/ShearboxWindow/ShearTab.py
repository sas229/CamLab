...
class ShearTabs(QTabWidget):
    ...
    def build_tab(self, cycle):
        ...
        self.cycles[cycle]["trigger_speed_select"] = QCheckBox("Enter shearing speed")
        self.cycles[cycle]["trigger_speed"] = QLineEdit()
        self.cycles[cycle]["trigger_calc_select"] = QCheckBox("Use the rate calculated during consolidation")
