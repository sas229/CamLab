...
class ControlUtilities:
    ...
    def changeControlWidget(self, device, channel, newWidget):
        ...
        # self.controls[controlID].deleteLater()
    ...
    #             # Add to tab bar.
    #             icon = QIcon("icon:/secondaryText/videogame_asset.svg")
    #             self.tabs.insertPersistentTab(index, controlWidget, controlChannelName, icon)
    #             index += 1
