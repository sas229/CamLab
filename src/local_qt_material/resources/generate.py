...
class ResourseGenerator:
    ...
    # ----------------------------------------------------------------------
    def __init__(self, primary, secondary, secondaryText, disabled, source, parent='theme'):
        """Constructor"""
        ...
        self.contex = [
            ...
            (os.path.join(self.index, 'secondary'), secondary),
            (os.path.join(self.index, 'secondaryText'), secondaryText),
        ]
