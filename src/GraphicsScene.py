...
class GraphicsScene(QtGui.QGraphicsScene):
    ...
    **Signals**
    ...
    sigMousePanned = QtCore.Signal() # Added by Federico Lattuada look at line 222
    sigMouseWheel = QtCore.Signal() # Added by Federico Lattuada look at line 229-231
